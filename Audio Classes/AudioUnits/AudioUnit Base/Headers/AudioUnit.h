...
class AudioUnit: public APAudio::Mainframe
{
public:
    ...
    virtual APAudio::AudioObject* getOutputObject(unsigned int channel) = 0;
    ...
    struct Inlet
    {
        ...
        std::vector<std::unique_ptr<SummerObject>> mixers;
    };
